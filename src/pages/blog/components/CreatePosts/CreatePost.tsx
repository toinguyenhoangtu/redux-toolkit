...
import { addPost, canclePost, editingPost } from "pages/blog/blog.reducer";
...
export default function CreatePost() {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    // set null value form when create new post
  ...
  return (
    <form onSubmit={handleSubmit} onReset={handelCancelEdit}>
      <div className="mb-6">
        <label
          htmlFor="title"
